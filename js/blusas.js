    ...
    if(producto.tipo == "blusa"){
      ...
      <div class="u-align-center u-container-style u-products-item u-repeater-item"">
          ...
          <a href="descripcion.html?id=${producto.id}">
              <img alt="" class="u-expanded-width u-image u-image-default u-product-control u-image-1" src="${producto.img}" data-image-height="385"><!--/product_image-->
          </a>   
          <div class="u-align-center u-container-style u-grey-10 u-group u-group-1">
              ...
              <a href="#" class="u-border-2 u-border-grey-25 u-btn u-btn-rectangle u-button-style u-palette-2-base u-product-control u-text-body-color u-btn-1"><!--product_button_content-->aGREGAR AL CARRITO<!--/product_button_content--></a><!--/product_button-->
              </div>
          </div>
          </div>
      </div>
