    ...
    if(producto.tipo == "blusa"){
      ...
      <div class="u-align-center u-container-style u-products-item u-repeater-item"">
          ...
          <div class="u-align-center u-container-style u-grey-10 u-group u-group-1 rounded">
              ...
              <a href="descripcion.html?id=${producto.id}" class="u-btn rounded u-button-style u-palette-2-base u-product-control u-text-body-color u-btn-1"><!--product_button_content-->&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ver detalles&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<!--/product_button_content--></a><!--/product_button-->
              </div>
          </div>
          </div>
      </div>
